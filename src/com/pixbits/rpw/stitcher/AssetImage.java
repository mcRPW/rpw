...
public class AssetImage implements Comparable<AssetImage>
{
  ...
  public int width() { return element.w; }
  public int height() { return element.h; }
  public int x() { return element.x; }
  public int y() { return element.y; }
  public void place(int x, int y) { element.x = x; element.y = y; }
  public void reset() { place(-1,-1); }
