...
public class AssetLayout implements Iterable<AssetImage>
{
  ...
  public Iterator<AssetImage> iterator() { return entries.iterator(); }
  ...
  public AssetImage first() { return entries.first(); }
  
  static String rectToString(Rectangle rc) { return "{"+rc.x+", "+rc.y+", "+rc.width+"x"+rc.height+"}"; }
