...
public class Paths
{
	...
	public static final String DIR_PROJECT_WORKING_COPY_TMP = DIR_TMP
			+ "/workdir";
	public static final String DIR_LIBRARY = "library";
	public static final String DIR_VANILLA = DIR_LIBRARY + "/"
			+ DIRNAME_VANILLA;
	public static final String DIR_RESOURCEPACKS = DIR_LIBRARY + "/"
			+ "resourcepacks";
	public static final String FILE_VANILLA_STRUCTURE = DIR_VANILLA
			+ "/structure.dat";
	...
	public static final String FILE_CFG_MODGROUPS = DIR_CONFIG
			+ "/modGroups.cfg";
	public static final String FILE_CFG_MODFILTERS = DIR_CONFIG
			+ "/modFilters.cfg";
	public static final String FILE_RECENTPROJECTS = DIR_CONFIG
			+ "/recentProjects.dat";
